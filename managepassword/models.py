...
class AllowedRoles(models.Model):
...
class DbList(models.Model):
    ...
    connect_str = models.CharField(max_length=200, blank=True, null=True)
...
class Manageruser(models.Model):
    ...
    allowed_host = models.CharField(max_length=200, blank=True, null=True)
...
class OperationLog(models.Model):
    ...
    operation = models.CharField(max_length=1000, blank=True, null=True)
